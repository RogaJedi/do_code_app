...
const level_2_task1 = TaskData(
  ...
  rows: [
    TaskRowData([
      RowItem.text("int a["),
      RowItem.drop("l2_t1_row1_slot"),
      RowItem.text("]"),
    ]),
    TaskRowData([
      RowItem.text("double b["),
      RowItem.drop("l2_t1_row2_slot"),
      RowItem.text("]"),
    ]),
    TaskRowData([
      RowItem.text("string c["),
      RowItem.drop("l2_t1_row3_slot"),
      RowItem.text("]"),
    ]),
  ],
  ...
  correctAnswers: {
    "l2_t1_row1_slot": "l2_t1_block1",
    "l2_t1_row2_slot": "l2_t1_block2",
    "l2_t1_row3_slot": "l2_t1_block3",
  },
);